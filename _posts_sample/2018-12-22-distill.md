...
<!-- <div class="l-page">
  <iframe src="{{ something here, placed below }}" frameborder='0' scrolling='no' height="500px" width="100%" style="border: 1px dashed grey;"></iframe>
</div> -->
<!-- '/assets/plotly/demo.html' | relative_url -->
